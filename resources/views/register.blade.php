        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Other Name is Required">
                        <input class="input100" type="text" name="othernames">
                        <span class="focus-input100"></span>
                        <span class="label-input100">Other Names</span>
                    </div>
                    ...
                    <div class="flex-sb-m w-full p-t-3 p-b-32">
                        <div class="wrap-input100 validate-input" data-validate="DOB is required">
                            <input class="input100" value="<?php echo date('Y-m-d'); ?>" type="date" name="dob">
                            <span class="focus-input100"></span>
                            <span class="label-input100">DOB</span>
                        </div>
                        <label class="checkbox-wrap">Male |
                            <input type="checkbox">
                            <span class="checkmark"></span>
                            </label>
                            <label class="checkbox-wrap"> Female
                                <input type="checkbox" >
                                <span class="checkmark"></span>
                                </label>
                    </div>
